...
function BotCard({ bot }: { bot: BotData }) {
  ...
  return (
    <div className="relative bg-white/70 dark:bg-[#2a243a] border border-[#e2d9fb] dark:border-[#6c4ab6] rounded-2xl p-6 shadow-xl backdrop-blur-md text-gray-900 dark:text-[#e6e0f9] transition-all duration-300 hover:shadow-[0_0_25px_4px_rgba(204,153,255,0.3)] hover:border-[#d5bdfc]">
      ...
      <div
        className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium ${
          bot.status === 'Online' ? 'bg-[#d5bdfc] text-gray-800' : 'bg-red-100 text-red-800'
        }`}
      >
...
function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-sans bg-[#fbfaff] text-gray-900 dark:bg-gradient-to-br dark:from-[#181827] dark:to-[#1e1b29] dark:text-[#e6e0f9]">
      ...
      {/* Header */}
      <header className="py-16 text-center z-10 relative">
        <img
      ...
      {/* Bot List */}
      <main className="max-w-6xl mx-auto px-4 pb-20 z-10 relative">
      ...
      {/* Footer */}
      <footer className="text-center text-sm text-gray-600 dark:text-[#aaa1cc] pb-8 z-10 relative">
